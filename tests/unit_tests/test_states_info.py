"""Tests for `address_validator.states_info`."""

import pytest

from address_validator.states_info import (
...
def test__is_city_capitol_of_state(city_name: str, state: str, is_capitol: bool):
    """Asser is_city_capitol_of_state() returns correct answer for city-state pairs."""
